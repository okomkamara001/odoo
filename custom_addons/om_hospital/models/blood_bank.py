...
class BloodBank(models.Model):
    ...
    partner_id = fields.Many2one('hospital.patient',
                                 string='Donor Name',
    ...
    assigned_patient_id = fields.Many2one('hospital.patient',
                                          string='Receiver',
                                          domain=[('patient_seq', 'not in',
                                                   ['New', 'Employee',
                                                    'User'])],

...
class HospitalPatient(models.Model):
    ...
    blood_group = fields.Selection([
        ...
        help="Blood group of the patients",
        string="Blood Group",
        required=True
    )
    ...
    marital_status = fields.Selection(
        ...
        string="Marital Status", help="Marital status of the patients")
    is_alive = fields.Selection([('alive', 'Alive'), ('dead', 'Dead'), ], default='alive',
                                help="True for alive patients")
    street = fields.Char(string="Street")
    street2 = fields.Char(string="Stree2")
    city = fields.Char(string="City")
    state_id = fields.Many2one('res.country.state', string="Street ID", required=True)
    zip = fields.Char(string="Zip")
    age = fields.Integer(string="Age")
    country_id = fields.Many2one('res.country', string="Country", help="Nationality of the patient")
    patient_seq = fields.Char(string="PatientNo.", help="Sequence number of the patient", copy=False, readonly=True,
                              index=True, default=lambda self: "New")
    notes = fields.Html(string="Note", help="Notes regarding the notes", sanitize_style=True)
    patient_profession = fields.Char(string="Profession", help="Profession of patients")
    doctor_id = fields.Many2one('hr.employee', domain=[('job_id.name', '=', 'Doctor')],
                                help="Family doctor of the patients")
    barcode = fields.Char(string="Barcode", help="Barcode for the patients")
    barcode_png = fields.Binary(string="Barcode PNG", help="Image file of the barcode", readonly=True)
    group = fields.Selection([('muslim', 'Muslim'), ('christian', 'Christian'), ('hindu', 'Hindu')],
                             string="Ethnic Group", help="Specify your religion")
    risk = fields.Text(string="Genetic Risks", help="Genetic risks of the patients")
    insurance_id = fields.Char(string="Insurance", help="Patients insurance")
    unique_id = fields.Char(string="Unique ID", help="Unique identities to fetch" "Patients insurance data")
    family = fields.Char(string="Family ID", help="Family of the patients")
    ...
    economic_level = fields.Selection([('low', 'Lower Class'), ('middle', 'Middle'), ('upper', 'Upper Class')],
    ...
    education_level = fields.Selection(
        ...
        string="Education Level", help="Education staus of pateint")
    house_level = fields.Selection(selection=[('good', 'Good'), ('bad', 'Bad'), ('poor', 'Poor')],
                                   string="House Condition", help="Specify your house's condition")
    work_home = fields.Boolean(string="Work At Home", help="True if you are working from home")
    hours_outside = fields.Integer(string="Hours Stay Outside Home",
                                   help="Specify how many hours you stay away" "from home")
    hostile = fields.Boolean(string="Hostile Area", help="Specify your house in a frienly" "neighbourhood")
    income = fields.Monetary(string="Income", help="The income of the patient")
    ...
    running = fields.Boolean(string='Running Water',
                             help="water that comes into a building through "
                                  ...
                                  "water.")
    electricity = fields.Boolean(string="Electricity", help="True if you have electricity")
    gas = fields.Boolean(string="Gas Supply", help="True if you have gas supply")
    trash = fields.Boolean(string="Trash Collection", help="True if you have trash collection")
    home_phone = fields.Boolean(string="Home Phone", help="True if you have home phone")
    ...
    help = fields.Selection([('yes', 'Yes'), ('no', 'No')], string="Family Help",
